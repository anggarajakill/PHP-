...
$id = @$_GET['id'];
if($_SERVER['REQUEST_METHOD'] === 'POST'){
					   if(($_POST['judul']) && ($_POST['isi']) && ($_POST['gambar'])){
						$judul = $_POST['judul'];
						$isi = $_POST['isi'];
						$gambar = $_POST['gambar'];
...
<div class="recentOrders">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="form-group">
            ...
            <input type="text" id="judul" name="judul" value="<?=$d['username'];?> required>
        </div><br>
        <div class="form-group">
           <label for="isi">Isi:</label>
           <textarea id="isi" name="isi" style="width: 500px; height: 200px;"value="<?=$d['username'];?> required></textarea>
        </div><br>
